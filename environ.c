 ...
 * @info: this struct containing arguments to maintain the function prototype.
 * Return: Always 0
 */
...
/**
 * _mysetenv -  this begins a new environment variable,or change a current one
 * @info: this struct containing potential arguments.
 *  Return: Always 0
 */
...
/**
 * _myunsetenv -  this should remove an environment variable
